...
lives_remaining = 3000000000000000
...
def create_big_egg():
    x = randrange(10,740)
    y = 40
    new_big_egg = c.create_oval(x,y,x+egg_width*1.5,y+egg_height*1.5,\
        fill='gold',width=0)
    eggs.append(new_big_egg)
    root.after(egg_interval,create_big_egg)
...
root.after(1000,create_big_egg)
