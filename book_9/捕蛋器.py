...
def create_big_egg():    #new,掉落重复，分数一样
    x = randrange(10,740)
    y = 40             
    new_egg = c.create_oval(x,y,x+egg_width*1.5,y+egg_height*1.5,\
        fill=next(color_cycle),width=0)
    eggs.append(new_egg)
...
root.after(1000,create_big_egg)    #new
